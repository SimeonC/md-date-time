    ...
    return {
      ...
      link: function(scope, element, attrs, ngModel) {
        ...
        attrs.$observe('weekdays', function(val) {
          if (val) {
            return val(scope._weekdays = val.substring(0, 7).split(''));
          }
        });
